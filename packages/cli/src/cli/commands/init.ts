...
skills:
  preprocess: ${toProjectRelativePath(projectPath, preprocessSkillPath)}
  postprocess: ${toProjectRelativePath(projectPath, postprocessSkillPath)}

workspace:
  preprocessContext: ${toProjectRelativePath(projectPath, getProjectPreprocessContextPath(projectPath))}
  enhancedAnalysis: ${toProjectRelativePath(projectPath, getProjectEnhancedAnalysisPath(projectPath))}
  postprocessContext: ${toProjectRelativePath(projectPath, getProjectPostprocessContextPath(projectPath))}
